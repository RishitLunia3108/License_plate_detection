...
# Check if the license plate text complies with the required India format
...
def get_car(license_plate, vehicle_track_ids):
    """
    Retrive the vehicle coordinates and ID based on the license plate coordinates.

    Args:
        license_plate (tuple):  Tuple comtaining the coordinates of the license plate (x1, y1, x2, y2, score, class_id)
